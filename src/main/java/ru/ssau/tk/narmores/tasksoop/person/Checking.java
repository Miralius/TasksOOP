...
public class Checking {
    ...
    /*1.14 задание: Сначала выводится Игнат, т.к. создается новый объект и присвается ссылке person внутри метода. После
    ...
    * Arkadiy, определённый в main*/
    ...
    /*1.13 задание: Сначала выполняется метод checkInt() и выводится число 10, несмотря на то, что мы передаем в этот метод 5.
